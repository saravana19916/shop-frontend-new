...
const SiteHeader = () => {
  ...
  const headerSelected: SiteHeaders =
    user && user!.token ? "Header 2" : "Header 1";

  // const [headerSelected, setHeaderSelected] = useState<SiteHeaders>(headS);
