  ...
  const renderButtonOpenModal = () => {
    return (
      ...
      >
        ...
        <span className="absolute right-2 top-1/2 transform -translate-y-1/2 w-9 h-9 flex items-center justify-center rounded-full md:border md:border-neutral-200 dark:border-neutral-6000 dark:text-neutral-300 sm:border-none">
          <svg
            viewBox="0 0 16 16"
            aria-hidden="true"
            role="presentation"
