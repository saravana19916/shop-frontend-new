      ...
      <Popover className={`AvatarDropdown relative flex`}>
        {({ open, close }) => (
          <>
            ...
            >
              <Popover.Panel className="absolute z-10 w-screen max-w-[300px] px-4 top-full sm:right-0 sm:px-0">
...
export default NavMobileAvatarDropdown;
