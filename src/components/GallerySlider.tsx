...
import { IEventType, Data, Event, ImageGallery } from "@/model/IEventType";
...
export default function GallerySlider({
  ...
  let currentImage =
    (images.length > 0 && images![index] && images![index].img_name) != ""
      ? process.env.AWS_CLOUD_FRONT_URL +
        "images/events/" +
        images![index].img_name
      : placeHolderImg;
